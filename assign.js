...
var clothingSection = document.getElementById("clothing-items");
var accessoriesSection = document.getElementById("accessories-items");
...
productList.forEach(function(item){
    if(item.isAccessory === true){
        ...
        newItemImage.className = "item-preview";
        newItemImage.src = item.preview;

        var newInnerDiv = document.createElement("div");
        newInnerDiv.className = "item-details";
        ...
        newInnerDiv.appendChild(itemTitle);
        newInnerDiv.appendChild(itemBrand);
        newInnerDiv.appendChild(itemPrice);

        newDiv.appendChild(newItemImage);
        newDiv.appendChild(newInnerDiv);

        accessoriesSection.appendChild(newDiv);
        ...
        clothingSection.appendChild(newDiv);
    }
}); 